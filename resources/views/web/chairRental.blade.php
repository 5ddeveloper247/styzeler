						...
						<div class="details col-lg-6">
							<div class="form-group">
								<input type="text" class="form-control change" id="salonName" name="salonName" 
									aria-describedby="salon-name"
									placeholder="Salon Name" autocomplete="nope" required>
							</div>
							<div class="form-group">
								<textarea class="form-control change" id="salonAddress" name="salonAddress"
							...
							<div class="form-group">
								<input type="text" class="form-control change"
									id="salon-country-code" aria-describedby="salonCountryCode" name="salonCountryCode"
							...
							<div class="form-group">
								<textarea class="form-control change" id="spaceDescription" name="spaceDescription"
									name="space-description" style="height:8vw;"
					...
					<div class="col-12 col-lg-5 col-xl-4">
						<div class="category">
							...
							<div class="mt-5">
								...
								<div class="form-group">
									<select id="rentalCategory" name="rentalCategory"
								...
								<h4 class="rent-and-let sub_heading" style="font-size: 22px !important;">Rent & Let</h4>
                                 <div class="form-group longRent rent-and-let">
                                   <select id="rent-let" name="rentAndLet" class="form-control sub_heading1" onchange="longRent(this);">
                                       <option value="">--select--</option>
                                   ...
                                   <br>
                                      <div class="weeklyRent">
                                        <input type="number" class="form-control" id="rent-let-charge-weekly" name="weeklyRent" aria-describedby="rent-let-charge" placeholder="Weekly Rate &pound;" >
                                      </div>
                                      <div class="monthlyRent">
                                        <input type="number" class="form-control" id="rent-let-charge-monthly" name="monthlyRent" aria-describedby="rent-let-charge" placeholder="Monthly Rate &pound;">
                                      </div>
                                </div>
               

                                <h4 class="rent-and-let-go sub_heading" style="font-size: 22px !important;">Rent & Let as you go</h4>
                                 <div class="form-group shortRent rent-and-let-go">
                                   <select id="rent-let-go" name="rentAndLetGo" class="form-control sub_heading1" onchange="shortRent(this);">
                                       <option value="">--select--</option>
                                   ...
                                   <br>
                                   <div class="dailyRent">
                                    <input type="number" class="form-control" id="rent-let-charge-go-daily" name="dailyRent" aria-describedby="rent-let-charge" placeholder="Daily Rate &pound;" >
                                  </div>
                                  <div class="hourlyRent">
                                    <input type="number" class="form-control" id="rent-let-charge-go-hourly" name="hourlyRent" aria-describedby="rent-let-charge" placeholder="Hourly Rate &pound;">
                                  </div>
                                </div>
                                

								<div class="form-group">
									<input type="file" id="chair-picture-1" name="chairPicture1" class="form-control" accept=".jpg, .jpeg, .png" multiple="false">
								</div>
								<div class="form-group">
									<input type="file" id="chair-picture-2" name="chairPicture2" class="form-control" accept=".jpg, .jpeg, .png" multiple="false">
								</div>
								<div class="form-group">
									<input type="file" id="chair-picture-3" name="chairPicture3" class="form-control" accept=".jpg, .jpeg, .png" multiple="false">
								</div>
								<div class="col-12">
...
<script>
		...
		$(document).ready(function () {
			...
			@elseif(Auth::user()->type == 'wedding' || Auth::user()->type == 'hairStylist' ||
					Auth::user()->type == 'beautician' || Auth::user()->type == 'barber' ||
