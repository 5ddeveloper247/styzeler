...
@section('content')
    <div class="profile container">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="profilePicture">
                            ...
                            <input id="stylist-picture" name="stylist_picture" class="my-4 hidden" type="file"
                                onchange="readURL(this);" placeholder="upload">
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                        <div class="form-group">
                            <input type="text" class="form-control" id="stylist-postcode"
        ...
        <div class="modal Hairdressing-service-product-modal" tabindex="-1" role="dialog" data-keyboard="false"
            data-backdrop="static">
            <div class="modal-dialog " role="document">
                <div class="modal-content bg-dark">
                    <div class="modal-header">
