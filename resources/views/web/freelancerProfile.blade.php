...
@section('content')
                    ...
                    <form id="hero_image_form">
                        ...
                        <div class="profilePicture">
                            ...
                            <input id="stylist-picture" name="stylist_picture" class="my-4 hidden" type="file"
                                onchange="loadFileProfile(event)" placeholder="upload">
                            <label for="stylist-picture">+</label>
                        </div>
                        </p>
                        <button type="submit" class="btn customBtn">Okay</button>
                    </form>
    ...
    <div class="modal name-mobile-modal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog " role="document">
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <!-- Qualification -->
    <div class="modal qualification-modal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog " role="document">
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="qualification my-5">
                        ...
                        <div class="form-group form-check">
                            <input class="form-check-input" type="checkbox" name="qualification[]" id="nvq-assesor"
                                value="NVQ Assesor, training asseso">
                    ...
                    BARBER   Skin fade, Comb over Scissors."></i></span>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control " type="file" id="public-liability-insurance"
                                name="public_liability_insurance" onchange="readPublicInsurance(this);">
                        </div>
                    </div>
                    </p>
                    <button type="button" class="btn customBtn" data-dismiss="modal"
                    ...
                    <div class="rate my-5">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="stylist_rate" id="120"
                                value="120">
                            <label class="form-check-label" for="120">
                                £120
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="stylist_rate" id="130"
                                value="130">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="stylist_rate" id="other"
                                value="other" onclick="$('div[id=otherRate]').toggle();">
                        ...
                        <div id="otherRate" style="display:none;">
                            <span style="left:131px;position: absolute; margin-left: 1px; margin-top: 4px;">£</span>
                            <input type="text" name="otherRate" value="0" class="form-control"
                                style=" height: 30px; width: 200px; margin: 0 auto;">
                        </div>
                    </div>
                    </p>
                    <button type="button" class="btn customBtn" data-dismiss="modal"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content bg-dark">
                ...
                <div class="modal-body">
                    ...
                    <p>
                    <div class="form-group">
                        <textarea class="form-control " id="stylist-resume" rows="3" placeholder="Resume"></textarea>
                    </div>
                    </p>
                    <button type="button" class="btn customBtn" data-dismiss="modal"
                        onclick="updateProfile()">Okay</button>
                ...
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="styling-products my-5">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="stylingProducts[]" id="baxter"
                                    value="Baxter">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="facials my-5">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="microdermabrasion-with-crystals">Microdermabrasion
                                    with
                                    Crystals</label>
                            </div>
                            <div class="form-check">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="male-grooming my-5">
                            ...
                            <div class="form-check">
                                ...
                                <input type="hidden" name="salonMaleGroomingServices[subHeading]" value="Services">
            ...
            <div class="modal-content bg-dark">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control " type="file" id="image-gallery" name="image-gallery"
