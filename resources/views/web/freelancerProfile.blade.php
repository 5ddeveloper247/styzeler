            ...
            <div class="showBook col-12 mt-5 text-left" id="showBook">
                ...
                <div class="row justify-content-center status-div">
                    ...
                    <div class="book-available col-6 col-md-4 col-lg-2 text-center">
                        <div class="option available customBtnNotSelected" onClick="avaliableAppointmentDate('Available')">
                            <a>Available</a>
                        </div>
                    </div>
                    <div class="book-oncall col-6 col-md-4 col-lg-2 text-center">
                        <div class="option oncall customBtnNotSelected" id="on_call_btn" onClick="avaliableAppointmentDate('On Call')">
                            <a>On Call</a>
                        </div>
                    </div>
                    <div class="book-off col-6 col-md-4 col-lg-2 text-center">
                        <div class="option off customBtnNotSelected" onClick="avaliableAppointmentDate('Off')" id="off_btn">
                            <a>Off</a>
                        </div>
                    </div>
