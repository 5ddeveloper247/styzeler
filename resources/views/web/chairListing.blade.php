...
@section('content')
    ...
    <div class="booking my-5">
        <div class="container">
            <h2 class="color-1 my-4 text-center">Your Chair Listing</h2>
            <div class="row justify-content-center">
                <div class="booking-box col-lg-8">
                    ...
                    <div class="row chair_booking_row p-3 text-left">
                        <!--<div class="col-4">
...
@push('script')
    ...
    <script src="{{ asset('template_old/js/chair-listing.js') }}?v={{ time() }}"></script>
@endpush
