...
<section id="about">
    <img
      src="{{ asset('template_new/assets/images/about-us-page- banner.JPG') }}"
      alt=""
      class="main_bg"
    />
    <div class="contain">
      ...
      <div class="video_block d-none d-md-block">
        <img
          src="{{ asset('template_new/assets/images/styzeler_can.png') }}"
          style="height: 391px"
          alt=""
        />
      ...
      <div class="use_links" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="inr">
          ...
          <div class="links_item">
            ...
            <div
              class="item"
              style="background-image: url('{{ asset('template_new/assets/images/about_link_gray.jpg') }}')"></div>
            <div
              class="item"
              style="background-image: url('{{ asset('template_new/assets/images/about_link_yellow.jpg') }}')"></div>
            <div
              class="item"
              style="background-image: url('{{ asset('template_new/assets/images/about_link_blue.jpg') }}')"></div>
            <div
              class="item"
              style="background-image: url('{{ asset('template_new/assets/images/about_link_red.jpg') }}')"></div>
            <div
              class="item"
              style="background-image: url('{{ asset('template_new/assets/images/about_link_gold.jpg') }}')"></div>
            <div
              class="item"
              style="background-image: url('{{ asset('template_new/assets/images/about_link_green.jpg') }}')"></div>
          </div>
        </div>
      </div>
    </div>
