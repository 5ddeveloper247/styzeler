...
<div class="wedding-header-banner my-5 d-none d-md-block">

	<img src="{{ asset('template_old/images/wedding-header-banner.png') }}" alt="" width="100%">

</div>

<div class="wedding-header-banner mb-5 d-block d-md-none">

      <img src="{{ asset('template_old/images/wedding-banner-small-3.png') }}" alt="" width="100%" height="120%">
