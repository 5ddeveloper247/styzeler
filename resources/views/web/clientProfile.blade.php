...
@section('content')
    <div class="profile container">
        <div class="profile-pic text-center" data-aos="fade-up"><img id="profile-image-id" alt="">
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                        <div class="profilePicture"><img id="blah" src="images/blank.png" alt="your image"><br><input
                                id="stylist-picture" name="stylist_picture" class="my-4 hidden" type="file"
                                onchange="readURL(this);" placeholder="upload"><label for="stylist-picture">+</label>
                        </div>
                        </p><button type="button" class="btn customBtn" data-dismiss="modal"
                            onclick="updateProfile()">Okay</button>
                        <!-- <button type="button" class="btn customBtn" data-dismiss="modal">Okay</button>-->
                    </div>
                ...
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"><input type="text" class="form-control" id="stylist-name"
                                name="stylist_name" aria-describedby="stylist-name" placeholder="Name">
                        </div>
                        <div class="form-group"><input type="text" class="form-control" id="stylist-surname"
                                name="stylist_surname" aria-describedby="stylist-surname" placeholder="Surname"></div>
                        </p><button type="button" class="btn customBtn" data-dismiss="modal"
                            onclick="updateProfile()">Okay</button>
                        <!-- <button type="button" class="btn customBtn" data-dismiss="modal">
                                                                                        Okay</button>--><!-- </form>-->
                ...
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"><input type="number" class="form-control" id="stylist-mobile"
                                aria-describedby="stylist-mobile" placeholder="Mobile"></div>
                        </p><button type="button" class="btn customBtn" data-dismiss="modal"
                            onclick="updateProfile()">Okay</button>
                        <!-- <button type="button" class="btn customBtn" data-dismiss="modal">
                                                                                            Okay</button>--><!-- </form>-->
        ...
        <!-- edit address -->
        <div class="modal address-modal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog " role="document">
                <div class="modal-content bg-dark">
                    <div class="modal-header"><button type="button" class="close" data-dismiss="modal"
                            aria-label="Close"><span aria-hidden="true">&times;
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                        <div class="form-group">
                            <textarea class="form-control" id="stylist-address" rows="3" placeholder="Address" spellcheck="false"></textarea>
                        </div>
                        </p><button type="button" class="btn customBtn" data-dismiss="modal"
                            onclick="updateProfile()">Okay</button>
                        <!-- <button type="button" class="btn customBtn" data-dismiss="modal">
        ...
        <!-- edit Postcode -->
        <div class="modal postcode-modal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog " role="document">
                <div class="modal-content bg-dark">
                    <div class="modal-header"><button type="button" class="close" data-dismiss="modal"
                            aria-label="Close"><span aria-hidden="true">&times;
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"><input type="text" class="form-control" id="stylist-postcode"
                                aria-describedby="owner-postcode" placeholder="Postcode"></div>
                        </p><button type="button" class="btn customBtn" data-dismiss="modal"
                            onclick="updateProfile()">Okay</button>
