...
<section id="business">
    ...
    <div class="contain">
      <div class="text_wrap_blk" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="data_01" style="background-image: url('{{ asset('template_new/assets/images/business_bg_01.jpg') }}')">
          <p>
        ...
        <div class="data_02" style="background-image: url('{{ asset('template_new/assets/images/business_bg_02.jpg') }}')">
          <p>
      ...
      <div class="content" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="btn_blk">
          <a href="registration.html" class="site_btn">Register <img src="{{ asset('template_new/assets/images/eye.svg') }}" alt="" /></a>
        </div>
      </div>
    </div>
        ...
        <div class="row flex_row">
          <div class="col-lg-4">
            <div class="package_blk">
              <div class="sm">Styzeler Hair and Beauty Recruiting Agency <br> Styzeler Hair and Beauty <br> Recrutining
                Freelancers All level</div>
              ...
              <div class="inner">
                ...
                <div class="listing">
                  <ul>
                    <li>
                      <div class="box"><img src="{{ asset('template_new/assets/images/tick.svg') }}" alt=""></div>
                ...
                <div class="btn_blk">
                  ...
                  <a href="javascript:void(0)" class="eye_btn popup-pkg1"><img src="{{ asset('template_new/assets/images/eye.svg') }}" alt=""></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="package_blk">
              ...
              <div class="inner">
                ...
                <div class="btn_blk">
                  <a href="booking.html" class="site_btn">Buy</a>
                  <a href="javascript:void(0)" class="eye_btn popup-pkg3"><img src="{{ asset('template_new/assets/images/eye.svg') }}" alt=""></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="contain" data-aos="fade-up" data-aos-duration="1000">
      <div class="btm_block">
        <ul class="btn_list">
          <li>
            <a href="?" class="shadow_btn" style="
                  font-size: 1.7rem;
                  padding: 0 1rem;
                  justify-content: space-between;
                ">Hairdressing / Babers <img src="{{ asset('template_new/assets/images/eye.svg') }}" alt="" /></a>
          </li>
          <li>
            <a href="?" class="shadow_btn" style="
                  font-size: 1.7rem;
                  padding: 0 1rem;
                  justify-content: space-between;
                ">Beauty / Spa <img src="{{ asset('template_new/assets/images/eye.svg') }}" alt="" /></a>
          </li>
        </ul>
    ...
    <div class="modal fade bd-example-modal-md" id="popup-pkg1" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content border border-warning" style=" background-color: black; color: white; max-height:400px; overflow-y:auto; ">
