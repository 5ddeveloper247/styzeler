    ...
    <div class="contain">
        ...
        <div class="flexBlocks" data-aos="fade-up" data-aos-duration="1000">
            <div class="column">
                ...
                <div class="inner" style="background-image: url('{{ asset('template_new/assets/images/candidate_block_bg.jpg') }}');">
                    <p>Candidates can be used in multiple ways, for a start-up business, they take away the pressure of fixed-wage, for established businesses Freelance can serve as stand-by or oversee waiting lists that become too long. A full-time position can be offered to a candidate that suits the company policy</p>
                </div>
            </div>
            <div class="column">
                <h1>Freelance <span>Is the new full time</span></h1>
                <div class="inner" style="background-image: url('{{ asset('template_new/assets/images/candidate_block_bg2.jpg') }}');">
                    <p>Styzeler’s reputation is based on exceptional reliability and professionalism providing clients, with experienced and qualified Freelancer, who have the skills to take any business and make a difference straight away, taking the pressure off overstretched permanent personnel</p>
                </div>
                <div class="btn_blk mt-5 pt-4 d-flex justify-content-end">
                    <a href="{{ route('register') }}" class="site_btn">Register <img src="{{ asset('template_new/assets/images/eye.svg') }}" alt=""></a>
                </div>
            </div>
        </div>
