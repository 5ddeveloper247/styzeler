    ...
    <div class="rent-let rent-let-div">
        ...
        <div class="container-fluid px-5">
            <div class="row justify-content-center my-4">
                <div class="col-5 col-md-2 text-lg-left text-center">
                    <img src="{{ asset('template_old/images/logo.png') }}" alt="">
                </div>
                <div class="col-7 col-md-10 text-md-left rental-text text-left">
                    <h2 class="color-1 mt-lg-5 mt-4">Maximise on your empty chair </h2>
                </div>
                <div class="col-12">
                    <p class="mt-4">It is estimated that there are 52,000 Hair & Beauty salon across the UK, 30% of them
                        have one empty chair or more for endless reasons from stylist being off or having misjudged the
                        business flow</p>
                    <p class="mt-4">Nonetheless, why not take advantage of rent & let as you go and maximise on your empty
                        chair for daily rent or for a permanent rent. Rent & Let for a start-up business, is a golden
                        opportunity that helps to reduce some of the overheads expenses and also create the right atmosphere
                        because an empty shop in not inviting</p>

                </div>
                <div class="col-lg-6">
                    <p class="color-1">
                        <u><a href="{{ route('contactUs') }}" class="color-1">For more info on Rent & Let contact styzeler
                                agency</a></u>
                    </p>
                </div>
            ...
            <div class="row justify-content-center my-4">
                <div class="col-5 col-md-2 text-md-left text-left">
                    <img src="{{ asset('template_old/images/logo.png') }}" alt="">
                </div>
                <div class="col-7 col-md-10 text-md-left rental-text text-left">
                    <h2 class="color-1 mt-lg-5 mt-4">Book a chair for few hours</h2>
                </div>
                <div class="col-12">
                    <p class="mt-4">With Rent & Let the chair can be rented for daily use!! for few hours Or for the whole
                        day, to those freelancers that might have a need for a professional and comfortable place to perform
                        a demanding service [[ photo shooting for a portfolio or a demanding customer ]] Daily rent gives
                        the Owner chance to be in control of the chair and assess the suitability of the freelancer in the
                        eventuality of an agreement for a permanent chair rental.</p>

                </div>

            </div>
            <div class="row justify-content-center my-4">
                <div class="col-5 col-md-2 text-lg-left text-left">
                    <img src="{{ asset('template_old/images/logo.png') }}" alt="">
                </div>
                <div class="col-7 col-md-10 text-md-left rental-text text-left">
                    <h2 class="color-1 mt-lg-5 mt-4">Rent & Let as you go </h2>
                </div>
                <div class="col-12">
                    <p class="mt-4">Rent & Let as you go it gives Freelancers the chance to utilise the commodity of a
                        salon service if a difficult client needs more attention or a difficult colour correction needs the
                        attention required or for a photo shooting where such a service can be performed.</p>
                </div>
                <div class="col-lg-6">
                    <p class="color-1">
                        <u><a href="{{ route('contactUs') }}" class="color-1">For more info on Rent & Let contact styzeler
