		...
		<div class="col-lg-10">
			...
			<form id="job-form" class="my-4">
				...
				<div class="form-group">
					<input type="text" class="form-control" id="applicant-name" name="applicant_name" placeholder="Applicant Name">
				</div>
				<div class="form-group">
					<input type="text" class="form-control" id="applicant-email" name="applicant_email" placeholder="Applicant Email">
				</div>
				<div class="form-group">
					<input type="number" class="form-control" id="applicant-phone" name="applicant_phone" placeholder="Applicant Phone">
				</div>
				...
				<div class="form-group text-left">
					...
					<input type="file" class="form-control" id="applicant-resume" name="applicant_cv" 
						accept=".pdf"  placeholder="Applicant Resume">
				</div>
