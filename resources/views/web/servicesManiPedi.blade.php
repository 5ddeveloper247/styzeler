    ...
    <script>
        ...
        function caseCat(i, subtype = '') {
            if (i == 'HydraRegular_Mani_Pedicurefacial') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">90 Minutes &pound;48</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '90').attr('data-price', '48').attr(
            ...
            if (i == 'Regular_Mani') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">45 Minutes &pound;24</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '45').attr('data-price', '24').attr(
            ...
            if (i == 'Regular_Pedicure') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">45 Minutes &pound;30</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '45').attr('data-price', '30').attr(
            ...
            if (i == 'Russian_Mani') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">45 Minutes &pound;35</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '45').attr('data-price', '35').attr(
            ...
            if (i == 'French_Mani_Pedicure') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">90 Minutes &pound;56</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '90').attr('data-price', '56').attr(
            ...
            if (i == 'Gel_Mani_Pedicure') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">120 Minutes &pound;60</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '120').attr('data-price', '60').attr(
            ...
            if (i == 'Gel_Mani') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">60 Minutes &pound;30</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '60').attr('data-price', '30').attr(
            ...
            if (i == 'Gel_Pedicure') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">60 Minutes &pound;35</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '60').attr('data-price', '35').attr(
            ...
            if (i == 'Acrylic_Nail_Extension') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">90 Minutes &pound;50</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '90').attr('data-price', '50').attr(
            ...
            if (i == 'Nail_Designs') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">50 Minutes &pound;10</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '50').attr('data-price', '10').attr(
            ...
            if (i == 'Nail_Art_Gel_mani') {
                $("#top_1").show();
                $("#top_1 p").html(
                    '<span class="my-auto">70 Minutes &pound;40</span> <img src="{{ asset('template_new/assets/images/cart-round.png') }}" alt="" class="cart_icon"/>'
                ).attr('data-time', '70').attr('data-price', '40').attr(
