    ...
    <div class="newProfile container my-5">
        ...
        <div>
            <form id="register_form" class="my-5">
                <input type="hidden" name="type" value="hairStylist">
                ...
                <div class="profilePicture">
                    ...
                    <input id="stylist-picture" name="stylist_picture" accept=".jpg, .jpeg, .png"
                        class="my-4 col-lg-6 hidden" type='file' onchange="loadFile(event);" placeholder="upload" />
                ...
                <div class="rate my-5">
                    <div class="d-flex align-items-baseline" style="gap: 2rem;color: #c4b9b0;">
                        <h4>Rate </h4>
                        <span>N/A For Home Service</span>
                    ...
                    <div id="otherRate" style="display:none;">
                        ...
                        <input type="number" name="otherRate" id="rateOther" value="0" class="form-control"
                ...
                <div class="makeup-styles my-5">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" id="blow-dry-makeup" value="Blow-dry & Make-up"
                            name="makeupServives[]">
                ...
                <div class="male-grooming my-5">
                    ...
                    <h5><u>Services</u></h5>
                    <div class="form-check">
                        <input type="hidden" name="salonMaleGroomingServices[heading]" value="Salon Male Grooming">
                ...
                <div class="hair-color my-5">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" id="cut-blowdry" value="Cut & Blowdry"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="hair-bridal" value="Hair Bridal"
                            name="hairColorServices[]">
                        <label class="form-check-label" for="hair-bridal">Hair Bridal</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="hair-extension" value="Hair Extension"
                            name="hairColorServices[]">
