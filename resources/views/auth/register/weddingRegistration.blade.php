...
@section('content')
    ...
    <div class="newProfile container my-5">
        <div class="newProfile-header">
            <h4>Wedding Stylist Profile Building </h4>
        ...
        <div>
            <form action="{{ route('registration') }}" method="POST" id="register_form" class="my-5">
                ...
                <div class="qualification my-5">
                    <h4>Qualification</h4>
                    {{-- <input type="hidden" name="qualification['heading']" value="Qualification"> --}}
                    ...
                    <div class="form-group">
                        <div class="tool-div col-lg-6">
                            ...
                            <!--<span style="float: right"><i class="fa fa-exclamation-circle exclamation ml-2" aria-hidden="true" data-toggle="tooltip" title="Public Liablity Insuarence" ></i></span>-->
                        </div>
                ...
                <div class="rate my-5">
                    ...
                    <div class="tool-div col-lg-6 my-2">
                        <label>£ To Be Quoted</label>
                        <!--<span style="float: right"><i class="fa fa-exclamation-circle exclamation ml-2" aria-hidden="true" data-toggle="tooltip" title="Only for wedding stylist" ></i></span>-->
                    </div>
                </div>
