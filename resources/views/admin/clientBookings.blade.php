        ...
        <section>
            <ul class="row nav nav-tabs navColor text-center" id="myTab" role="tablist" style="width: 100%;">
                ...
                <li class="col-lg-3 nav-item">
                    <a class="nav-link active" href="#panel0" data-toggle="tab"> Cancelled Bookings </a>
                </li>
                <li class="col-lg-3 nav-item">
                    <a class="nav-link" href="#panel1" data-toggle="tab"> Confirmed Bookings </a>
                </li>
                {{-- <li class="col-lg-3 nav-item">
                                                ...
                                                <div class="col-8">
                                                    <div>
                                                        ...
                                                        <div id="toggle{{ $row->id }}" style="display: none;">
                                                            ...
                                                            <div>
                                                                <p style="overflow-wrap: break-word;"><strong>Client
                                                                        Category:
                                                                    </strong> {{ @$row['adminClientUser']->type }}</p>
                                                            </div>
                                                            <div>
                                                                <p style="overflow-wrap: break-word;"><strong>Client Email:
                                                                    </strong> {{ @$row['adminClientUser']->email }}</p>
                                                            </div>
                                                            <div>
                                                                <p style="overflow-wrap: break-word;"><strong>Client Mobile:
                                                            ...
                                                            <div>
                                                                <p style="overflow-wrap: break-word;"><strong>Booking
                                                                    ...
                                                                    {{ !empty($row) && !empty($row->status) ? $row->status : $row['userAppointment']->status }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="booking-box col-lg-8">
                                ...
                                <div class="row confirm-appointment p-3 text-left" id="confirmed">
                                    @if (@count($appointments))
                                        @forelse ($appointments as $row)
                                            @if (!empty($row) && str_contains(strtolower($row->status), 'booked'))
                                                @php
                                                    $creationDate = date('d-M-Y', strtotime(@$row->created_at));
                                                    $bookDate = date('d-M-Y', strtotime(@$row->booking_date));
                                                @endphp
