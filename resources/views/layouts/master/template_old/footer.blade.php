    ...
    <div class="contain" data-aos="fade-up" data-aos-duration="1000">
        <div class="d-flex txt icon-container">
            ...
            <div class="d-flex social-media">
                ...
                <h1><a target="_blank" href="https://g.page/r/CbZ4IkhN9ROREAE"><i class="fa fa-map-marker color-1" aria-hidden="true"></i></a></h1>
            </div>
        </div>
...
<script>
    ...
    $(window).on("load", function() {
        $(document).on("click", "nav > button.toggle", function() {
            $("nav > button.toggle").toggleClass("active")
            $("nav").toggleClass("active")
            $("nav .contain").slideToggle()
            /* $("html").toggleClass("flow")
            $("body").toggleClass("move")
            $("nav").toggleClass("active") */
        });
        $(document).on("click", "nav > button.toggle.active", function() {
            $("nav > button.toggle").removeClass("active")
