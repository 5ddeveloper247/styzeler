...
@section('content')
     ...
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       <div class="content">
         <h1>Styzeler <small>Agency</small></h1>
         <h2>Hair & Beauty</h2>
   ...
   <section id="browse">
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       ...
       <h2 class="h2_01">
         Specialist in Hair & Beauty Recruitmen, London & Uk <br />
       ...
       >
         ...
         <p style="margin: 10px 0px 11px 13px">
           Besides offering our clients a bespoke service, we make sure that
           all our candidate enjoy an excellent working environment
         </p>
         <h3 style="margin: 10px 0px 11px 13px">
           Small businesses rely on freelancers
         </h3>
         <p style="margin: 10px 0px 11px 13px">
           A Business Owner can hire a Freelancer for an unlimited or
           designated short period, ensuring the job is completed while
           searching for the perfect candidate or offer a full-time position to
           a Freelancer who suits the business philosophy. Hiring a Freelancer
           can also be a great solution to take away the pressure of fixed-wage
           and allows the freedom of booking,
         </p>
       </div>
       <img
         src="{{ asset('template_new/assets/images/line_gray.jpg') }}"
         alt=""
         class="browse_line_gray"
       />
       <div class="d-block d-md-none">
         <div class="reg_line">
           <span style="font-size: 3rem; color: #c4b9b0"
             >Freelancers Help Small Businesses Grow</span
           >
           <p>
             By working full-time for a long time often employees run out of
             ...
             creativity and motivate full-time employees
           </p>
         </div>
         ...
         /></a>
         <img
           src="{{ asset('template_new/assets/images/line_yellow.jpg') }}"
           alt=""
           class="browse_line_yellow"
       ...
       <div class="txt">
         ...
         <p class="">
           Before onboarding a freelancer, you can look at their work
           portfolio, check product knowledge and skillset and interview them
           to ensure they are the right fit for your project
         </p>
       </div>
     </div>
   </section>
   ...
   <section
     ...
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       <div class="content">
         ...
         <h1>To Hire</h1>
         <a type="button" href="packages2.html">
   ...
   <section
     class="d-lg-none d-md-none mt-4"
     id="hiree"
     style="
       background-image: url('{{ asset('template_new/assets/images/recompre-min.JPG') }}';
     ...
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       <div class="content_mobile">
         ...
         >
           <img
             src="{{ asset('template_new/assets/images/hire_play_btn.jpg') }}"
       ...
       <div class="flexRow" style="padding: 0px 38px">
         <div class="col">
           ...
           >
             ...
             <div class="txt">
               <p>
                 freelancers focus on getting a good review and expanding their
         ...
         <div class="col">
           ...
           >
             ...
             <div class="txt">
               <p>
                 Spending hours freelancing across various roles you can learn
                 new skills and enrich your CV
               </p>
             </div>
           </div>
         </div>
         <div class="col">
           ...
           >
             ...
             <div class="txt">
               <p>
                 Styzeler is the leading male grooming agency across London &
                 UK we offer master barbers to craft art for our clients
               </p>
             </div>
           </div>
         </div>
   ...
   <section id="startup">
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       <div class="image_blk">
         <img
           src="{{ asset('template_new/assets/images/startup_image_00.jpg') }}"
           alt=""
           class="desktop"
         />
         <img
           src="{{ asset('template_new/assets/images/styzeler home-freedom.JPG') }}"
           alt=""
           class="mobile"
         />
         <div class="txt">
           <img
             ...
             id="home_section_logo"
             width="40"
             height="40"
             src="{{ asset('template_new/assets/images/home_next_logo.jpg') }}"
             alt=""
           />
           <div>
       ...
       <div class="data">
         <p>
           For Start-up businesses it is unpredictable to quantify the volume
           ...
           freedom of booking. and ease up the pressure of fixed wages.
         </p>
         <p>
           <a href="?"
             ><u
     ...
     <img
       src="{{ asset('template_new/assets/images/STYZELER-homepage-3.JPG') }}"
       alt=""
       class="img-fluid"
     />
   </section>
     ...
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       <div class="flexRow">
         <div class="col-12">
           <div class="data">
             <h2>
               Styzeler membership <br />
               buy it now !!
             </h2>
           </div>
         </div>
         <div class="col col1">
           <img src="{{ asset('template_new/assets/images/membership_01.jpg') }}" alt="" class="img1" />
           <p>
             There are many reasons companies are turning to freelancers rather
             than hiring full-time staff.
           </p>
           <p>
             Freelancers are increasingly seen as highly skilled professionals
             with valuable abilities that can take any business forward
           </p>
         </div>
         <div class="col col2" style="text-align: center">
           <a
             href="packages2.html"
             type="button"
             style="background: transparent; border: 0; margin-top: 134px"
           >
             <img src="{{ asset('template_new/assets/images/hire_play_btn.jpg') }}" alt="" />
           </a>
         </div>
         <div class="col col3">
           <img src="{{ asset('template_new/assets/images/membership_02.jpg') }}" alt="" class="img2" />
           <p>
             Freelancers create an opportunity to expand the diversity of your
             company. Diversity helps increase the flow of ideas and often
             leads to better business solutions.
           </p>
         </div>
       </div>
       <div class="strip">
         <span class="title">Styzeler Agency</span>
         <span>The winning formula for both</span>
         <span>Businesses Owner & Freelancer</span>
       </div>
     </div>
   </section>
     ...
     <div class="contain">
       <div class="row">
         ...
         <div class="col-md-12">
           <p>
             There are many reasons companies are turning to freelancers rather
             than hiring full-time staff.Freelancers are increasingly seen as
             highly skilled professionals with valuable abilities that can take
   ...
   <section id="get_job">
     <div class="contain" data-aos="fade-up" data-aos-duration="1000">
       <div class="image">
         ...
         <div class="txt">
           <p>
             Through freelancing , people who wouldn’t normally get the job
           </p>
           <h2>get the job</h2>
         </div>
       </div>
       ...
       <div class="modal-dialog modal-md" style="width: 350px">
         ...
         >
           <div class="modal-header" style="border-bottom: 5px solid #766d48">
             ...
             <i class="close-modal" style="font-size: 2rem; cursor: pointer"
               ><b>&times;</b></i
             >
           </div>
           <div class="modal-body my-5">
             <p class="fs-2">
               To continue browsing the pages, please choose a category
             </p>
           </div>
         </div>
       </div>
