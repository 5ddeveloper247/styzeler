	...
	<div class="contain" data-aos="fade-up" data-aos-duration="1000">
		<div class="content">
			...
			<div class="logo mylogodiv">
				<a href="{{ url('/') }}"> <img
					src="{{ asset('template_new/assets/images/logo.png') }}" alt="" />
				</a>
			</div>
...
<section class="d-lg-none d-md-none">
	<img src="{{ asset('template_new/assets/images/new_home_1.jpg') }}"
		alt="" />
</section>
<!-- banner -->
<section id="browse">
	<div class="contain" data-aos="fade-up" data-aos-duration="1000">
		...
		<ul class="btn_list">
			<li><a href="{{route('home_service')}}" class="shadow_btn"
				style="font-size: 1.7rem; padding: 0 1rem; justify-content: space-between;">Home
					Services <img
					src="{{ asset('template_new/assets/images/eye.svg') }}" alt="" />
			</a></li>
			<li><a href="{{route('businessOwner')}}" class="shadow_btn"
				style="font-size: 1.7rem; padding: 0 1rem; justify-content: space-between;">Business
					Owner <img src="{{ asset('template_new/assets/images/eye.svg') }}"
					alt="" />
			</a></li>
		...
		<img src="{{ asset('template_new/assets/images/line_gray.jpg') }}"
			alt="" class="browse_line_gray" />
		<div class="d-block d-md-none">
			...
			<a href="{{ route('register') }}" class="site_btn"
				style="border: #000000">Register <img
				src="{{ asset('template_new/assets/images/eye.svg') }}" alt="" /></a>
			<img src="{{ asset('template_new/assets/images/line_yellow.jpg') }}"
				alt="" class="browse_line_yellow"
		...
		<div class="reg_line d-none d-md-block">
			...
			<img src="{{ asset('template_new/assets/images/line_yellow.jpg') }}"
				alt="" class="browse_line_yellow" style="margin-top: 32px" /> <span
...
<section id="categ">
	<div class="img-box d-none d-md-block">
		<img src="{{ asset('template_new/assets/images/categ_bg_main.jpg') }}"
			alt="" />
		<div class="cta">
	...
	<div class="contain" data-aos="fade-up" data-aos-duration="1000">
		...
		<div class="flexRow" style="padding: 0px 38px">
			<div class="col">
				<div class="inner"
					...
					<div class="image">
						<img
							src="{{ asset('template_new/assets/images/categ_photo_02.jpg') }}"
							alt="" />
					</div>
					<div class="txt">
			...
			<div class="col">
				<div class="inner"
					...
					<div class="image">
						<img
							src="{{ asset('template_new/assets/images/categ_photo_03.jpg') }}"
							alt="" />
					</div>
					<div class="txt">
			...
			<div class="col">
				<div class="inner"
					...
					<div class="image">
						<img
							src="{{ asset('template_new/assets/images/categ_photo_01.jpg') }}"
							alt="" />
					</div>
					<div class="txt">
		...
		<div class="btm" style="margin-right: 6px">
			<img src="{{ asset('template_new/assets/images/line_purple.jpg') }}"
				alt="" /> <a href="{{route('registration')}}" class="site_btn">Register
	...
	<div class="contain" data-aos="fade-up" data-aos-duration="1000">
		<div class="image_blk">
			<img
				...
				alt="" class="mobile" />
			<div class="txt">
				<img class="d-block d-md-none" id="home_section_logo" width="40"
					height="40"
...
<section class="d-none d-md-block" id="membership">
	<div class="contain" data-aos="fade-up" data-aos-duration="1000">
		<div class="flexRow">
			...
			<div class="col col1">
				<img
					src="{{ asset('template_new/assets/images/membership_01.jpg') }}"
					alt="" class="img1" />
			...
			<div class="col col3">
				<img
					src="{{ asset('template_new/assets/images/membership_02.jpg') }}"
					alt="" class="img2" />
	...
	<div class="contain">
		<div class="row">
			...
			<div class="col-md-12 mt-5">
				<img src="{{ asset('template_new/assets/images/homepage-2.png') }}"
					alt="" />
...
<section id="get_job">
	<div class="contain" data-aos="fade-up" data-aos-duration="1000">
		<div class="image">
			<img src="{{ asset('template_new/assets/images/get_job.jpg') }}"
				alt="" />
			<div class="txt">
	...
	<div class="modal fade bd-example-modal-md" id="popupInfo-modal"
		role="dialog">
