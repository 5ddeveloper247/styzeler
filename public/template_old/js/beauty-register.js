...
function sendEmail() {
    let ownerMessage =
        "A new Candiate registered as Beauty Owner on Styzeler Website. Please go through the details on Adminpanel.";
    var settings = {
        url: "./email.php",
        method: "POST",
        timeout: 0,
    ...
    $("#register-form").submit(function (e) {
        ...
        $.each(bodyWaxProducts, function (i) {
            ...
            if (bodyWaxProducts[i] != 0) {
                refinedBodyWaxProducts =
                    refinedBodyWaxProducts + bodyWaxProducts[i] + ", ";
            }
        });
        ...
        //merging serviceName + serviceHeader +serviceSubheader
        let bodyWaxProduct = {
            _ServiceName: refinedBodyWaxProducts,
        ...
        let maniPediService = {
            ...
            _ServiceHeader: "Manicure Pedicure",
            _ServiceSubHeader: "Services",
        };
        //console.log(headService);
        ...
        if (postcode != "") {
            if (!postcode.match(postCodeLetters)) {
                ...
                $(".terms-conditions-modal").modal("hide");
                $(".error-message").append(
                    "Postcode must contain only numbers!<br>"
                );
                count = 1;
            }
        } else {
