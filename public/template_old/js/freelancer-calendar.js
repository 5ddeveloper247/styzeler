                                        ...
                                        function (j) {
                                            ...
                                            if (
                                                ...
                                                html +=
                                                    `<div title="" class="` +
                                                    changeSlot +
                                                    ` option col-md-2 mr-2 ${status}" ><del>` +
                                                    starttimeAMPM +
                                                    ` - ` +
                                                    endtimeAMPM +
                                                    `</del></div >`;
                                                ...
                                                if (
                                                    ...
                                                    html +=
                                                        `<div title="" class="` +
                                                        changeSlot +
                                                        ` option col-md-2 mr-2 ${status}")>After 9</div>`; //` + starttimeAMPM + ` -
                                                    slots_times.push(
                                                        showResponse.data[i][
                                                            "booking_time_slots"
                                                        ][j]["slots_time"]
                        ...
                        if (slots_times != "") {
                            $.each(filtered_times, function (k) {
                                if (filtered_times[k] != "After_Nine") {
                                    if (filtered_times[k] != "After_Nine") {
                                        let time_after_nine_1 =
                                            filtered_times[k].slice(-2);
                                        let time_after_nine_2 =
                                            filtered_times[k].slice(-2);

                                        var time_after_nine1 =
                                            filtered_times[k].split(" - ")[0];
                                        var time_after_nine2 =
                                            filtered_times[k].split(" - ")[1];

                                        if (
                                            time_after_nine_2 === "AM" ||
                                            time_after_nine_2 === "PM"
                                        ) {
                                            time_after_nine_1 =
                                                time_after_nine1;
                                            time_after_nine_2 =
                                        ...
                                        slot_time_html +=
                                            `<div title = "Edit Slot" class="option col-md-3 mr-2" onclick="changeSlotTime('` +
                                            filtered_times[k] +
                                            `')"> ` +
                                            time_after_nine_1 +
                                            ` - ` +
                                        ...
                                        function (j) {
                                            ...
                                            if (
                                                ...
                                                html +=
                                                    `<div title="" class="` +
                                                    changeSlot +
                                                    ` option col-md-2 mr-2 ${status}" disabled><del>` +
                                                    starttimeAMPM +
                                                    ` - ` +
                                                    endtimeAMPM +
                                                    `</del></div >`;
