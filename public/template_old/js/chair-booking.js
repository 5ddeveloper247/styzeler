                ...
                $.each(response.bookings, function (i) {
                    ...
                    $(".chair_booking_row").append(
                        '<div class="col-4">' +
                            ...
                            i +
                            '">' +
                            "<p><strong>Salon Name: </strong>" +
                            response.bookings[i]["_SalonName"] +
                            "</p>" +
                            "</span>" +
                            ...
                            response.bookings[i]["_ApplicantName"] +
                            "</p>" +
                            "</span>" +
                            ...
                            i +
                            '">' +
                            "<p><strong>Applicant Email: </strong>" +
                            response.bookings[i]["_ApplicantEmail"] +
                            "</p>" +
                            "</span>" +
                            '<span class="mobile_' +
                            i +
                    ...
                    if (
                        response.bookings[i]["_Status"] === "cancel" ||
                        response.bookings[i]["_Status"] === "CANCELLED"
                    ) {
                        $("#show" + i).hide();
                ...
                $.each(response.bookings, function (i) {
                    ...
                    $(".chair_booking_row").append(
                        '<div class="col-4">' +
                            ...
                            i +
                            '">' +
                            '<div class="text-center customBtn" onClick="confirmAppointment(' +
                            id +
                            ')">' +
                            "<a>Confirm</a>" +
                            "</div>" +
                            '<div class="text-center customBtn" onClick="holdAppointment(' +
                            id +
                            ')">' +
                            "<a>On Hold</a>" +
                            "</div>" +
