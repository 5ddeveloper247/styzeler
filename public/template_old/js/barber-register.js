...
function redirectToPage() {
    window.location.href = "./barber-stylist-buildup.html";
}

function sendEmail() {
    let ownerMessage =
        "A new Candiate registered as Barber Stylist on Styzeler Website. Please go through the details on Adminpanel.";
    var settings = {
        url: "./email.php",
        method: "POST",
        timeout: 0,
