...
function rentChair(id) {
    ...
    //If the user is logged in then s/he can book

    //Or else
    //Modal show- you're not logged in
                ...
                if (response.salonSpaces[i]["_IsActive"] === "1") {
                        ...
                        $(".chair-row")
                            ...
                            .append(
                                '<div class="col-lg-6 mt-5"> ' +
                                    '<div id="' +
                                    response.salonSpaces[i]["_SalonChairId"] +
                                    '" >' +
                                    '<div class="row">  <div class="col-md-6 therapist-content p-3 px-4">' +
                                    "<h4>" +
                                    response.salonSpaces[i]["_Category"] +
                                    "</h4>" +
                                    "<p><strong>" +
                                    "Rent as you go" +
                                    "</strong></p>" +
                                    "<p><strong>" +
                                    "Daily rent £" +
                                    response.salonSpaces[i]["_DailyRate"] +
                                    "</strong></p>" +
                                    //   '<p>'+'Or Hourly rent depends what the business owner feels more confortble with'+'</p>'+
                                    "<p><strong>Name: </strong>" +
                                    response.salonSpaces[i]["_SalonName"] +
                                    "</p>" +
                                    "<p><strong>Address: </strong>" +
                                    response.salonSpaces[i]["_SalonAddress"] +
                                    "</p>" +
                                    "<p><strong>Country: </strong>" +
                                    response.salonSpaces[i]["_SalonCountry"] +
                                    "</p>" +
                                    "<p><strong>County: </strong>" +
                                    response.salonSpaces[i]["_SalonCounty"] +
                                    "</p>" +
                                    '<p><strong>Email: </strong><a href="mailto:' +
                                    response.salonSpaces[i]["_SalonEmailId"] +
                                    '">' +
                                    response.salonSpaces[i]["_SalonEmailId"] +
                                    '</a><span class="customTooltip"> <span class="exclamation"> <i class="fa fa-exclamation" aria-hidden="true"></i> </span> <span class="tooltiptext">Use the email to contact business owner for more info!</span> </span> </p>' +
                                    // "<p><strong>Mobile: </strong>" +
                                    // response.salonSpaces[i][
                                    //     "_SalonMobileNumber"
                                    // ] +
                                    // " </p>" +
                                    ...
                                    "</p>" +
                                    "<p><strong>Space Description: </strong>" +
                                    response.salonSpaces[i][
                                        "_SpaceDescription"
                                    ] +
                                    "</p>" +
                                    ...
                                    '<div id="carouselExampleControls_' +
                                    i +
                                    '" class="carousel slide" data-ride="carousel">' +
                                    '<div class="carousel-inner">' +
                                    '<div class="carousel-item active">' +
                                    '<img id="salon-image-id-' +
                                    i +
                                    '" alt="" width="100%" height="400px">' +
                                    //    '<img class="d-block w-100" src="..." alt="First slide">' +
                                    "</div>" +
                                    '<div class="carousel-item">' +
                                    '<img id="salon-image-id-2' +
                                    i +
                                    '" alt="" width="100%" height="400px">' +
                                    //    '<img class="d-block w-100" src="..." alt="Second slide">'
                                    "</div>" +
                                    '<div class="carousel-item">' +
                                    '<img id="salon-image-id-3' +
                                    i +
                                    '" alt="" width="100%" height="400px">' +
                                    ...
                                    "</div>" +
                                    '<div class="mt-4">' +
                                    '<a class="carousel-control-prev-1" href="#carouselExampleControls_' +
                                    i +
                                    '" role="button" data-slide="prev">' +
                                    '<span class="carousel-control-prev-icon" aria-hidden="true"></span>' +
                                    '<span class="sr-only">Previous</span>' +
                                    "</a>" +
                                    '<a class="carousel-control-next-1" style="float:right" href="#carouselExampleControls_' +
                                    i +
                        ...
                        $(".chair-row")
                            ...
                            .append(
                                '<div class="col-lg-6 mt-5"> ' +
                                    ...
                                    "<p><strong>" +
                                    "Hourly rent £" +
                                    response.salonSpaces[i]["_HourlyRate"] +
                                    "</strong></p>" +
                        ...
                        $(".chair-row")
                            ...
                            .append(
                                '<div class="col-lg-6 mt-5"> ' +
                                    ...
                                    "<p><strong>" +
                                    "Monthly rent £" +
                                    response.salonSpaces[i]["_MonthlyRate"] +
                                    "</strong></p>" +
                        ...
                        $(".chair-row")
                            ...
                            .append(
                                '<div class="col-lg-6 mt-5"> ' +
                                    ...
                                    "<p><strong>" +
                                    "Weekly rent £" +
                                    response.salonSpaces[i]["_WeeklyRate"] +
                                    "</strong></p>" +
                    ...
                    $.ajax({
                        ...
                        success: function (salonImageResponse) {
                            ...
                            $("#salon-image-id-" + i).attr(
                                "src",
                                "data:image;base64," +
                                    salonImageResponse["_ImageContent"]
                            );
                        },
                    });
                    $.ajax({
