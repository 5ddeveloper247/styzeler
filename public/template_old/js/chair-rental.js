...
function checkLogin() {
    ...
    if (typeof loggedStatus !== "undefined" && loggedStatus !== null) {
        ...
        if (
            loggedMode === "Hairdressing Owner" ||
            loggedMode === "Beauty Owner"
        ) {
        } else {
...
$(function () {
    $("#submitData").on("click", function (e) {
        ...
        if (salonName != "") {
            if (!salonName.match(letters)) {
                ...
                $(".error-message").append(
                    "Saloon name must contain only letters!<br>"
                );
                count = 1;
            }
        } else {
        ...
        //Address validation
        let addressLetters =
            /^[A-Za-z0-9 ':-_+.,A-Za-z0-9 '-_:+.,]||[0-9A-Za-z ':-_+.,A-Za-z0-9 '-_:+.,]+$/;
        ...
        if (salonAddress != "") {
            if (!salonAddress.match(addressLetters)) {
                ...
                $(".terms-conditions-modal").modal("hide");
                $(".error-message").append(
                    "Please provide proper address!<br>"
                );
                count = 1;
            }
        } else {
        ...
        if (salonCountryCode != "") {
            if (!salonCountryCode.match(postCodeLetters)) {
                ...
                $(".terms-conditions-modal").modal("hide");
                $(".error-message").append(
                    "Post code must contain only numbers!<br>"
                );
                count = 1;
            }
        } else {
        ...
        if (salonCountry != "") {
            if (!salonCountry.match(countryLetters)) {
                ...
                $(".terms-conditions-modal").modal("hide");
                $(".error-message").append(
                    "Country name must contain only letters!<br>"
                );
                count = 1;
            }
        } else {
        ...
        if (salonCounty != "") {
            if (!salonCounty.match(countryLetters)) {
                ...
                $(".terms-conditions-modal").modal("hide");
                $(".error-message").append(
                    "County name must contain only letters!<br>"
                );
                count = 1;
            }
        } else {
        ...
        if (spaceDescription != "") {
            if (spaceDescription.length < 10) {
                ...
                $(".terms-conditions-modal").modal("hide");
                $(".error-message").append(
                    "Please tell us a bit more about Space Description! min - 10 letters<br>"
                );
                count = 1;
                ...
                if (!spaceDescription.match(resumeLetters)) {
                    ...
                    $(".terms-conditions-modal").modal("hide");
                    $(".error-message").append(
                        "Please use proper letters in space description!<br>"
                    );
                    count = 1;
                }
            }
        ...
        //Picture validation
        if (
            typeof chairPicture1 === "undefined" &&
            typeof chairPicture2 === "undefined" &&
            typeof chairPicture3 === "undefined"
        ) {
            $(".error-modal").modal("show");
            $(".terms-conditions-modal").modal("hide");
