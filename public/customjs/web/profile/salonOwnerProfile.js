...
function populateCheckboxes(data, elementType, serviceName, checkboxName) {
    ...
    if (services) {
        ...
        profileProductServices(services, elementArray, elementParagraph, elementHeading);
        const serviceArray = objectToArray(services);

        serviceArray.forEach(function (service) {
            $(`input[type="checkbox"][name="${checkboxName}[]"][value="${service}"]`).prop('checked', true);
        });
    }
}
...
//            $('#status').append('<a class="text-center btn" onclick="editStatus();" title="Edit">✎</a>');
            ...
            if (type === 'hairdressingSalon') {
                populateCheckboxes(data, 'stylingProducts', 'stylingProducts', 'stylingProducts');
                populateCheckboxes(data, 'chemicalTreatmentProducts', 'chemicalTreatmentProducts', 'chemicalTreatmentProducts');
                populateCheckboxes(data, 'chemicalTreatmentServices', 'chemicalTreatmentServices', 'chemicalTreatmentServices');
                populateCheckboxes(data, 'hairCuttingServices', 'hairCuttingServices', 'hairCuttingServices');
                populateCheckboxes(data, 'barberMaleGroomingServices', 'barberMaleGroomingServices', 'barberMaleGroomingServices');
                populateCheckboxes(data, 'hairColorServices', 'hairColorServices', 'hairColorServices');
                populateCheckboxes(data, 'hairColorBrands', 'hairColorBrands', 'hairColorBrands');
            } else if (type === 'beautySalon') {
                populateCheckboxes(data, 'massageServices', 'massageServices', 'massageServices');
                populateCheckboxes(data, 'massageProducts', 'massageProducts', 'massageProducts');
                populateCheckboxes(data, 'hairRemovalPermanentServices', 'hairRemovalPermanentServices', 'hairRemovalPermanentServices');
                populateCheckboxes(data, 'ladyWaxingServices', 'ladyWaxingServices', 'ladyWaxingServices');
                populateCheckboxes(data, 'ladyWaxingProducts', 'ladyWaxingProducts', 'ladyWaxingProducts');
                populateCheckboxes(data, 'maleWaxingServices', 'maleWaxingServices', 'maleWaxingServices');
                populateCheckboxes(data, 'manicurePedicureServices', 'manicurePedicureServices', 'manicurePedicureServices');
                populateCheckboxes(data, 'manicurePedicureProducts', 'manicurePedicureProducts', 'manicurePedicureProducts');
                populateCheckboxes(data, 'facialServices', 'facialServices', 'facialServices');
                populateCheckboxes(data, 'facialProducts', 'facialProducts', 'facialProducts');
                populateCheckboxes(data, 'homeServiceFacialServices', 'homeServiceFacialServices', 'homeServiceFacialServices');
                populateCheckboxes(data, 'bodyTreatmentServices', 'bodyTreatmentServices', 'bodyTreatmentServices');
                populateCheckboxes(data, 'EyesAndBrowServices', 'EyesAndBrowServices', 'EyesAndBrowServices');
                populateCheckboxes(data, 'EyesAndBrowProducts', 'EyesAndBrowProducts', 'EyesAndBrowProducts');
                populateCheckboxes(data, 'bodyWaxingProducts', 'bodyWaxingProducts', 'bodyWaxingProducts');
                populateCheckboxes(data, 'bodyWaxingServices', 'bodyWaxingServices', 'bodyWaxingServices');
            }
        }
    }
