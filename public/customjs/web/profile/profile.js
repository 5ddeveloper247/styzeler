    ...
    if (response.status == 200) {
        ...
        if (data != null || data != "") {
            ...
            $("#ownerQualification").append(
                '<a class="text-center btn" onclick="editQualification()" title="Edit">✎</a>'
            );
            ...
            $("#ownerWork").text(zone);
            $("#ownerWork").append(
                '<a class="text-center btn" onclick="editWork()" title="Edit">✎</a>'
            );
            ...
            $("#remaining_tokens").text(
                data.tokens != null && data.tokens != "" ? data.tokens : "0"
            );
            $("#total_tokens").text(
                data.total_tokens != null && data.total_tokens != ""
                    ? data.total_tokens
                    : "0"
            );
            ...
            if (galleryImages) {
                ...
                for (var i = 0; i < galleryImages.length; i++) {
                    ...
                    var imageHtml =
                        ...
                        '">' +
                        "<p>" +
                        '<a class="text-center btn" onclick="deletePicture(\'' +
                        imageSrc +
                        '\')" title="Edit"><u>remove</u></a>' +
                        "</p>" +
                        "</div>";
